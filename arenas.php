    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12 text-center">
                <h1 class="font-weight-light page-font-big">ARENAS</h1>
                <p class="page-font-small">MOB ARENAS</p>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 text-left pb-2 bordered" data-aos="fade-right">
                ...
                <p class="truncate">
                    Far away up in the North, a powerful tribe was known for its riches hidden away deep in the ice. After centuries of domination, they suddenly disappeared, leaving behind legendary treasures guarded by an unknown evil.
