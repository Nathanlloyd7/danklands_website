...
final class Settings {
    ...
    public function __construct($connect = true) {
        ...
        $this->host = 'eu02-sql.pebblehost.com';
        $this->port = 3306;

        $database = 'customer_129607_litebans';

        $username = 'customer_129607_litebans';
        $password = 'EgtU5nDPF#neCp!7';
        ...
        $this->name = 'The Danklands';

        // Clicking on the header name will send you to this address.
        $this->name_link = 'https://danklands.com';
        ...
        $this->discord_link = 'discord.danklands.com';
        ...
        $this->meta_title = 'The Danklands Ban List';
        $this->meta_description = 'Welcome to the Danklands BanList! You can see our bans, mutes, warns, and kicks!';
