...
<section class="main-session-info">
    <div class="container" data-aos="fade-left">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="text-green ">Looking for your next venture?</h1>
                ...
                <p><br>
                    ...
                    Come and check out our Discord: discord.danklands.com<br>
                    Join the server directly: play.danklands.com<br><br>
